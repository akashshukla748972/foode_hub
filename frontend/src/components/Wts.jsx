...
const Wts = () => {
  return (
    <div className="py-12 w-[95%] mx-auto sm:py-16 md:py-20 lg:py-24 xl:py-28 bg-gradient-to-br from-orange-50 to-amber-50 relative overflow-hidden">
          ...
          <div className="relative group">
            ...
            <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 md:-bottom-6 md:-right-2 bg-white p-2 sm:p-3 md:p-4 rounded-2xl shadow-lg">
              <img
                src={Wts3}
                alt="Customer"
                className="w-10 h-10 sm:w-12 sm:h-12 md:h-14 rounded-full border-4 border-orange-100"
              />
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          <div className="bg-white 30 backdrop-blur-sm rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 xl:p-14 shadow-xl border border-white/20 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <h2
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4 sm:mb-6 lg:mb-8 leading-tight"
