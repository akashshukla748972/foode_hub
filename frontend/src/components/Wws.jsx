...
const Wws = () => {
  ...
  return (
    <div className="w-[95%] min-h-screen bg-gradient-to-r from-red-50 to-yellow-50 px-4 sm:px-6 lg:px-20 py-12 md:py-20 xl:py-24">
            ...
            >
              <div className="overflow-hidden">
                <img
                  src={item.img}
                  alt=""
                  className="w-full hover:rotate-7 h-49 sm:h-56 md:h-48 lg:h-56 xl:h-64 object-contain lg:object-cover transition-transform duration-300"
                />
              </div>
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-orange-600 mt-4 ms:mt-6 font-poppins">
                {item.title}
              </h3>
