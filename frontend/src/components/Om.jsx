...
const Om = () => {
  ...
  return (
    <div className="min-h-screen mx-auto w-[95%]  bg-gradient-to-br form-orange-50 to-yellow-50 py-12 px-4 sm:px-6 md:px-8 lg:px-8 flex flex-col md:flex-col lg:flex-row items-center gap-8">
      {/* left sidebar */}
      <div className="w-full md:w-3/6 lg:w-1/4 bg-white p-4 md:p-6 rounded-3xl shadow-lg border border-amber-300">
        <h1 className="text-3xl md:text-4xl font-pacifico text-amber-600 mb-4 md:mb:-6 uppercase text-center">
          Our Menu
        </h1>
        <p className="text-base md:text-lg font-comfoataa text-amber-700 italic mb-4 md:mb-6 text-center">
        ...
        <div className="space-y-3 md:space-y-4">
          {menuItems.map((item, index) => (
            ...
            >
              <div
                className={`w-10 h-10 md:w-12 md:h-12 flex items-center justify-center founded-full bg-gradient-to-r ${
                  selectedItem.name === item.name
