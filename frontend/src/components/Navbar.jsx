...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-yellow-400 to-orange-500 shadow-lg rounded-full px-3 sm:px-4 md:px-4 lg:px-8 py-2 md:py-3 w-[95%] md:w-[90%] max-w-7xl flex justify-between items-center backdrop-blur-md border-white/20 z-50">
      {/* logo section */}
      <div className="flex items-center space-x-2">
        <div className="p-2 bg-white/20 rounded-full backdrop-blur-sm">
          <FaUtensils className="text-xl text-white animate-pulse" />
        </div>
        <h1 className="text-xl font-sans lg:text-2xl md:text-sm font-bold text-black">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="hidden sm:flex items-center space-x-2 bg-gradient-to-br from-yellow-300 to-orange-400 px-2 sm:px-2 md:px-0.5 lg:px-4 py-2 rounded-full shadow-lg hover:scale-105 transition-all focus:outline-none whiteapace-nowrap">
            <FaUser className="text-white md:text-sm text-lg" />
            <span className="font-semibold text-white text-xs sm:text-sm md:text-sm lg:text-base">
              Login
            </span>
          </button>
        </div>
        ...
        {/* mobile menu */}
        <div
          className={`md:hidden absolute top-full left-0 right-0 bg-gradient-to-b from-red-500 to-orange-600 rounded-2xl shadow-xl space-y-4 mt-3 mx-4 transition-all duration-300 transform p-4 ${
            isOpen
              ? "opacity-100 visible scale-110"
        ...
        >
          ...
          <div className="sm:hidden">
            <div className="flex items-center bg-white/20 rounded-full px-3 py-1 w-full">
              <input
                type="text"
                placeholder="Search..."
