...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-orange-50 via-white/40 to-orange-100 border-t-8 border-orange-200 py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 marker:gap-10 lg:gap-8 sm:mb-12">
          ...
          <div className="text-center sm:text-left space-y-3 sm:space-y-4">
            <h2 className="text-4xl sm:text-5xl md:text-4xl lg:texxt-4xl font-bold text-orange-600 font-serif tracking-wide drop-shadow-lg inline-block px-4 sm:px-6 md:px-8 lg:px-4 py-2 sm:py-4 md:py-3 lg:py-2 border-2 border-gray-300 rounded-full bg-transparent">
              Foodie's Hub
            </h2>
            <p className="text-gray-700 font-comfotaa text-lg sm:text-xl md:text-xl italic">
              Serving happiness since 2024
            </p>

            <div className="flex justify-center sm:justify-start space-x-2 sm:space-x-3 rounded-full">
          ...
          {/* contact section */}
          <div className="text-center sm:text-left space-y-3 ms:space-y-4">
        ...
        {/* Newsletters section */}
        <div className="bg-white/30 backdrop-blur-xl rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 lg:p-8 shadow-lg sm:shadow-2xl max-w-4xl mx-auto mb-5 sm:mb-12 border border-white /20">
          <div className="text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-4">
              <input
                ...
                className="w-full px-4 sm:px-6 md:px-8 lg:px-4 py-3 sm:py-4 md:py-3 lg:py-2 bg-transparent border border-orange-200 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-300 text-base sm:text-lg placeholder:gray-500"
              />
        ...
        <div className="border-t border-orange-200 pt-6 sm:pt-8 text-center space-y-3 sm:space-y-4">
          <p className="text-gray-600 font-comfortaa text-sm sm:text-base md:text-xl">
            ...
            by Akash Kumar Shukla
          </p>
          <p className="text-gray-600 font-comfortaa text-sm sm:text-base md:text-xl">
            Designed By{" "}
            <a
              href="#"
              className="text-orange-600 font-comfortaa cursor-pointer hover:text-purple-600 font-semibold"
            >
              Akash Kumar Shukla
            </a>
          </p>
